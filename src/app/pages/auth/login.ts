...
@Component({
    selector: 'app-login',
    standalone: true,
    imports: [FormsModule, CommonModule, ReactiveFormsModule, ButtonModule, CheckboxModule, InputTextModule, PasswordModule, FormsModule, RouterModule, RippleModule],
    template: `
                ...
                <div style="border-radius: 56px; padding: 0.3rem; background: linear-gradient(180deg, var(--primary-color) 10%, rgba(33, 150, 243, 0) 30%)">
                    <div class="w-full bg-surface-0 dark:bg-surface-900 py-20 px-8 sm:px-20" style="border-radius: 53px">
                        ...
                        <div [formGroup]="formGroup">
                            ...
                            <input pInputText id="email1" type="text" placeholder="Usuario" class="w-full md:w-120 mb-8" formControlName="username" [ngClass]="{ 'ng-dirty ng-invalid': submite && f['username'].errors }" />

                            @if (submite && f['username'].errors) {
                                <div class="text-red-500 text-sm ml-2 mt-1">
                            ...
                            <p-password
                                ...
                                [ngClass]="{ 'ng-dirty ng-invalid': submite && f['password'].errors }"
                            ></p-password>

                            @if (submite && f['password'].errors) {
                                <div class="text-red-500 text-sm ml-2 mt-1">
    ...
    onLogin() {
        if (this.formGroup.valid) {
            this.authService.login(this.formGroup.getRawValue()).subscribe({
                next: (r) => {
                    if (r.error) {
                        this.notificacion.mostrarMensaje(0, r.mensaje);
                        return;
                    }

                    this.authService.guardarToken(r.data.token, '');
